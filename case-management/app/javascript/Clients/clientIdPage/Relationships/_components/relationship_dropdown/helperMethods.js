...
export const formatClientBirthDate = clientBirthDate => {
  return DateTime.fromFormat(clientBirthDate, 'M/d/yyyy');
};

export const getClientBirthDate = client => {
  return formatClientBirthDate(client.birth_dt);
};

export const doesClientHaveDOB = client => {
  const clientBirthDate = formatClientBirthDate(client.birth_dt);
